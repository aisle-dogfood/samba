				 ...
				 struct interface *ifaces)
{
	...
	/* Removed wildcard binding to 0.0.0.0 for security.
	   Only bind to specific interfaces to reduce attack surface.
	   The per-interface bindings below provide sufficient coverage. */
