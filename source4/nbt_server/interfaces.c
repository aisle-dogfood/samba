				 ...
				 struct interface *ifaces)
{
	...
	/* Bind only to specific interfaces to reduce attack surface.
	   NetBIOS services should not be exposed on all interfaces
	   due to security concerns with UDP/137 and UDP/138. */
