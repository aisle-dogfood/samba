				 ...
				 struct interface *ifaces)
{
	...
	/* Bind only to configured network interfaces to limit exposure.
	   Wildcard binding (0.0.0.0) is removed to prevent exposing
	   NetBIOS services (UDP/137, UDP/138) to all interfaces. */
