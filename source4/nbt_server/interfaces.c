				 ...
				 struct interface *ifaces)
{
	...
	/*
	 * Only bind to explicitly configured interfaces.
	 * Binding to the wildcard address (0.0.0.0) exposes NBT services
	 * on all network interfaces, which increases the attack surface
	 * unnecessarily. The per-interface bindings below provide all
