				 ...
				 struct interface *ifaces)
{
	...
	/* Only bind to configured network interfaces to minimize
	   attack surface. Binding to wildcard address (0.0.0.0) would
	   expose NBT services on all interfaces regardless of configuration. */
