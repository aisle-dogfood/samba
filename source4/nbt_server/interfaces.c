				 ...
				 struct interface *ifaces)
{
	...
	/* Bind only to configured interfaces to limit exposure.
	   The "bind interfaces only" setting controls access restrictions
	   on those interfaces, not whether to bind to wildcard addresses. */
