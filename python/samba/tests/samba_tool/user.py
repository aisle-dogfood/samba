...
class UserCmdTestCase(SambaToolCmdTest):
    ...
    def test_setpassword(self):
        ...
        attributes = "sAMAccountName,unicodePwd,supplementalCredentials,virtualClearTextUTF8,virtualClearTextUTF16,virtualCryptSHA256,virtualSambaGPG"
        ...
        for user in self.users:
            ...
            if "virtualSambaGPG:: " in out:
                ...
                self.assertMatch(out, "virtualCryptSHA256: ",
                                 "getpassword virtualCryptSHA256: out[%s]" % out)
