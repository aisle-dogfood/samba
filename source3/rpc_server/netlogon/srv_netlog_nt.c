				   ...
				   struct netr_ServerAuthenticate3 *r)
{
	...
	/*
	 * AES support is now mandatory for Netlogon authentication.
	 * We will return DOWNGRADE_DETECTED with negotiate_flags = 0
	...
	/*
	 * Always require AES support for Netlogon authentication
	 * to prevent fallback to weak MD4-based cryptography.
	 */
